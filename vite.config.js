  ...
  build: {
    rollupOptions: {
      input: {
        ...
        typeitPricing: resolve(__dirname, 'typeit-pricing.html'),
        ...
        blogCertifiers: resolve(__dirname, 'blog/how-type-it-saves-certifiers-time.html'),
        ...
        landingTrades: resolve(__dirname, 'ai-receptionist-trades.html'),
        landingRealEstate: resolve(__dirname, 'ai-receptionist-real-estate.html'),
      },
    },
  },
})
